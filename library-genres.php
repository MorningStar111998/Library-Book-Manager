        ...
        <?php foreach ($books as $book) : ?>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100 text-center">
                    <img src="assets/freepik_assistant_1756211321087.png" class="card-img-top mx-auto" alt="<?php echo $book->getTitle(); ?>">
                    <div class="card-body">
                        <h5 class="card-title"> <?php echo $book->getTitle(); ?> </h5>
                        <p class="card-text">By <?php echo $book->getAuthor(); ?> </p>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
